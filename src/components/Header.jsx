            ...
            <ul className="flex font-medium lg:flex-row lg:space-x-8 lg:mt-0 w-full">
              ...
              <li>
                <a
                  ...
                  className="block cursor-pointer py-2 pr-4 pl-3 text-gray-700  hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                  style={{ color: "rgb(99 102 241)" }}
                >
                  About
                </a>
